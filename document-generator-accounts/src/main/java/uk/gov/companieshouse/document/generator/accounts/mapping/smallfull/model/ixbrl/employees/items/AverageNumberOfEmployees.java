package uk.gov.companieshouse.document.generator.accounts.mapping.smallfull.model.ixbrl.employees.items;
...
public class AverageNumberOfEmployees {
    ...
    public boolean equals(Object o) {
        if (this == o)
            return true;
        if (! (o instanceof AverageNumberOfEmployees))
            return false;
        AverageNumberOfEmployees that = (AverageNumberOfEmployees) o;
